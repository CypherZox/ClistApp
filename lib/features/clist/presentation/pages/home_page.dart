        ...
        children: [
          ...
          Padding(
            ...
            child: BlocBuilder<ClistBloc, ClistState>(
              ...
              return
                  // clistState is CacheLoaded
                  //     ? BlocBuilder<res.ClistResourceBloc, res.ClistResourceState>(
                  //         builder: (context, resState) {
                  //         if (resState is res.Loading) {
                  //           return Center(
                  //             child: CircularProgressIndicator(
                  //               valueColor: new AlwaysStoppedAnimation<Color>(
                  //                   AppColors.secondary),
                  ...
                  //       })
                  //     :
                  clistState is! Loaded && clistState is Error
                      ? Center(
                          child: SizedBox(
                            width: 350,
                            child: Column(
                                ...
                                GestureDetector(
                                  onTap: () {
                                    BlocProvider.of<ClistBloc>(context)
                                        .add(GetClist());
                                    BlocProvider.of<res.ClistResourceBloc>(
                                            context)
                                        .add(res.GetClistR());
                                    setState(() {});
                                  },
