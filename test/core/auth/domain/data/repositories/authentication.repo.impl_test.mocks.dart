...
// in clistApp/test/core/auth/domain/data/repositories/authentication.repo.impl_test.dart.
...
class MockFirebaseAuth extends _i1.Mock implements _i4.FirebaseAuth {
  ...
  _i5.Future<_i4.UserCredential> signInWithProvider(
          _i3.AuthProvider? provider) =>
      (super.noSuchMethod(Invocation.method(#signInWithProvider, [provider]),
              returnValue:
                  Future<_i4.UserCredential>.value(_FakeUserCredential_2()))
          as _i5.Future<_i4.UserCredential>);
  @override
